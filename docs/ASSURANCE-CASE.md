...
[NFR SEC-*](NON_FUNCTIONAL_REQUIREMENTS.md#1-security), [SECURITY.md](https://github.com/platformrelay/MKurator/blob/main/SECURITY.md),
...
| --- | --- | --- |
| Solo maintainer (bus factor 1) | Documented in [GOVERNANCE.md](https://github.com/platformrelay/MKurator/blob/main/GOVERNANCE.md) | Co-maintainer when feasible |
