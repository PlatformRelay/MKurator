...
[`config/samples/messaging_v1beta1_queuemanagerconnection.yaml`](https://github.com/platformrelay/MKurator/blob/main/config/samples/messaging_v1beta1_queuemanagerconnection.yaml)
...
[`config/samples/messaging_v1beta1_queue.yaml`](https://github.com/platformrelay/MKurator/blob/main/config/samples/messaging_v1beta1_queue.yaml)
