...
Use the process in [SECURITY.md](https://github.com/platformrelay/MKurator/blob/main/SECURITY.md) — do not open public issues for vulnerabilities.

### Where is the full documentation site?

Published docs: [platformrelay.github.io/MKurator](https://platformrelay.github.io/MKurator/). Source lives under
[`docs/`](index.md).
