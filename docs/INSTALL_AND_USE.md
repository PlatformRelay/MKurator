...
use **`0.15.0`** (or the tag you downloaded from GitHub Releases). Older tags
(before `v0.5.0`) do not include `ChannelAuthRule` and `AuthorityRecord`; check
release notes before upgrading.

```sh
VERSION=0.15.0   # replace with your release tag
...
current chart (**0.15.0**), apply updates in this order:
