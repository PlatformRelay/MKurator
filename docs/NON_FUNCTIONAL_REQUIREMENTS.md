...
| ID | Req | Priority | Verification |
|----|-----|----------|--------------|
| API-1 | CRDs follow Kubernetes API conventions; the `v1beta1` contract may change but changes are deliberate and documented. See [API_STABILITY.md](API_STABILITY.md). | MUST | Review |
