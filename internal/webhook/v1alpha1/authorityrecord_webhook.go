...
// +kubebuilder:webhook:path=/validate-messaging-mkurator-dev-v1alpha1-authorityrecord,mutating=false,failurePolicy=fail,sideEffects=None,groups=messaging.mkurator.dev,resources=authorityrecords,verbs=create;update,versions=v1alpha1,name=vauthorityrecord.kb.io,admissionReviewVersions=v1
