...
// +kubebuilder:rbac:groups=messaging.mkurator.dev,resources=authorityrecords,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=messaging.mkurator.dev,resources=authorityrecords/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=messaging.mkurator.dev,resources=authorityrecords/finalizers,verbs=update
